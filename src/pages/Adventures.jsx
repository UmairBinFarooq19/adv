...
export default function Adventures() {
  return (
    <>
      <PageHeader eyebrow="Adventures" title="Adventure activities" lead="Skiing, snowboarding, trekking, gondola rides and lakeside mornings across the valley." />
      <Section>
        <SectionHeading
          eyebrow="Coming together"
          title="This page is scaffolded"
          lead="Drop the real Adventures content here using the shared UI components (Card, Section, Button)."
        />
