...
export default function About() {
  return (
    <>
      <PageHeader eyebrow="About us" title="Our story" lead="Locally rooted, quietly ambitious. Meet the guides and planners behind AdventuresKashmir." />
      <Section>
        <SectionHeading
          eyebrow="Coming together"
          title="This page is scaffolded"
          lead="Drop the real About content here using the shared UI components (Card, Section, Button)."
        />
