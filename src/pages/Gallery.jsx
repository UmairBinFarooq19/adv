...
export default function Gallery() {
  return (
    <>
      <PageHeader eyebrow="Gallery" title="The valley, in frames" lead="Photography from recent expeditions and the lodges we call home." />
      <Section>
        <SectionHeading
          eyebrow="Coming together"
          title="This page is scaffolded"
          lead="Drop the real Gallery content here using the shared UI components (Card, Section, Button)."
        />
